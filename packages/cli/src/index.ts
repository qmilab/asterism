#!/usr/bin/env bun
// @qmilab/asterism — the `asterism` CLI bin.
//
// Thin surface: wire the real outside world (stdin/stdout/env/cwd, an
// interactive confirmation prompt) into `runCli` and translate its return value
